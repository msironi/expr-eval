  ...
  describe('functions', function () {
    describe('atan2(y, x)', function () {
      ...
      it('should return undefined if one of the input values is undefined', function () {
        var parser = new Parser();
        assert.strictEqual(parser.evaluate('atan2(undefined,2)'), undefined);
        assert.strictEqual(parser.evaluate('atan2(2,undefined)'), undefined);
      });
    });
    ...
    describe('filter(f, array)', function () {
      ...
      it('should return undefined if undefined is passed as the array', function () {
        var parser = new Parser();
        assert.deepStrictEqual(parser.evaluate('f(a, i) = i > 3; filter(f, undefined)'), undefined);
      });
    });
    ...
    describe('hypot(a, b, ...)', function () {
      ...
      it('should return undefined if one of the input values is undefined', function () {
        var parser = new Parser();
        assert.strictEqual(parser.evaluate('hypot(undefined)'), undefined);
        assert.strictEqual(parser.evaluate('hypot(10^100, 11^100, undefined, 12^100, 13^100)'), undefined);
      });
    });
    ...
    describe('if(p, t, f)', function () {
      ...
      it('if(1==undefined, 10, 0)', function () {
        assert.strictEqual(Parser.evaluate('if(1==undefined, 10, 0)'), 0);
      });

      it('if(2 > 5, 1, undefined)', function () {
    ...
    describe('indexOf(target, array)', function () {
      ...
      it('should return undefined if undefined is passed as the array', function () {
        var parser = new Parser();
        assert.strictEqual(parser.evaluate('indexOf(2.5, undefined)'), undefined);
        assert.strictEqual(parser.evaluate('indexOf("5", undefined)'), undefined);
      });
    });
    ...
    describe('join(sep, array)', function () {
      ...
      it('should return undefined if one of the arguments is undefined', function () {
        var parser = new Parser();
        assert.strictEqual(parser.evaluate('join(undefined, [1, 2, 3])'), undefined);
    ...
    describe('map(f, a)', function () {
      ...
      it('should return undefined if undefined is passed as the array', function () {
        var parser = new Parser();
        assert.deepStrictEqual(parser.evaluate('f(a) = a*a; map(f, undefined)'), undefined);
      });
    });
    ...
    describe('max(a, b, ...)', function () {
      ...
      it('should return undefined if one of the input values is undefined', function () {
        var parser = new Parser();
        assert.strictEqual(parser.evaluate('max(4,3,2,1,0,undefined,1,2,3,4,-5,6)'), undefined);
        assert.strictEqual(parser.evaluate('max([1,0,2,-4,undefined,8,-16,3.2])'), undefined);
      });
    });
    ...
    describe('min(a, b, ...)', function () {
      ...
      it('should return undefined if one of the input values is undefined', function () {
        var parser = new Parser();
        assert.strictEqual(parser.evaluate('min(4,3,2,1,0,undefined,1,2,3,4,-5,6)'), undefined);
        assert.strictEqual(parser.evaluate('min([1,0,2,-4,undefined,8,-16,3.2])'), undefined);
      });
    });
    ...
    describe('pow(x, y)', function () {
      ...
      it('should return undefined if one of the input values is undefined', function () {
        var parser = new Parser();
        assert.strictEqual(parser.evaluate('pow(undefined,2)'), undefined);
